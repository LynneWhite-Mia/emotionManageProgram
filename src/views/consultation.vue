    ...
    <div class="consultation-container">
        ...
        <div class="chat-main">
            ...
            <div class="chat-messages">
                ...
                <div v-for="msg in message" :key="msg.id" class="message-item"
                    ...
                    <div class="message-content">
                        <div class="message-bubble">
                            <!-- AI正在思考中 -->
                            <div v-if="msg.senderType === 2 && isAiTyping && !msg.content && msg === message[message.length - 1]"
                        ...
                        {{ msg.senderType === 2 && isAiTyping && msg === message[message.length - 1] ? '正在输入中...' :
                            msg.createdAt }}
                    </div>
                </div>
            </div>
            ...
            <div class="chat-input">
                ...
                <el-button :disabled="!userMessage.trim() || userMessage.length === 0" type="primary" class="send-btn"
                    title="发送消息">
                    <el-icon>
                        <Promotion />
                    </el-icon>
...
const loadSessionEmotion = (sessionId) => {
  ...
  getSessionEmotion(id).then(res => {
    console.log(res)
    if (res && res.isNegative !== undefined) {
...
const startAIResponse = (sessionId, textContent) => {
